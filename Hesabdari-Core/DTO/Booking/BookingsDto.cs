...
public record BookingsItemResult(Guid Id, string Status, int TotalPrice, int NumNights, int NumGuests, string HeroSlideName, string GuestName, string Email, string CountryFlag, string StartDate, string EndDate, string CreateAt);
...
public record BookingResult(Guid Id, string Status, int TotalPrice, string HeroSlideName,  string CountryFlag, string Nationality);
