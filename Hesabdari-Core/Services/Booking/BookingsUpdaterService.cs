    ...
    public class BookingsUpdaterService : IBookingsUpdaterService
    {
        ...
        public async Task<BookingResult> UpdateBooking(Guid bookingId, JsonPatchDocument<Booking> patchDoc)
        {
            ...
            return await _unitOfWork.ExecuteTransactionAsync(async () =>
            {
                ...
                return new BookingResult(updatedBooking.Id, updatedBooking.Status, updatedBooking.TotalPrice, updatedBooking.HeroSlide.Name, updatedBooking.Guest.CountryFlag, updatedBooking.Guest.Nationality);
            });
        }
